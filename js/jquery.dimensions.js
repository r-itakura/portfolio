...
<head>
	...
	<title>Page not found | jQuery Plugin Registry</title>
	...
	<link rel="shortcut icon" href="http://plugins.jquery.com/jquery-wp-content/themes/plugins.jquery.com/i/favicon.ico">

	<link rel="stylesheet" href="http://plugins.jquery.com/jquery-wp-content/themes/jquery/css/base.css?v=1">
	<link rel="stylesheet" href="http://plugins.jquery.com/jquery-wp-content/themes/plugins.jquery.com/style.css">
	<link rel="pingback" href="http://plugins.jquery.com/xmlrpc.php" />
	<!--[if lt IE 7]><link rel="stylesheet" href="css/font-awesome-ie7.min.css"><![endif]-->

	<script src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/js/modernizr.custom.2.6.2.min.js"></script>

	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
	<script>window.jQuery || document.write(unescape('%3Cscript src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/js/jquery-1.9.1.min.js"%3E%3C/script%3E'))</script>
	<script src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/js/jquery-migrate-1.1.1.min.js"></script>

	<script src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/js/plugins.js"></script>
	<script src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/js/main.js"></script>

	<script src="//use.typekit.net/wde1aof.js"></script>
	<script>try{Typekit.load();}catch(e){}</script>

<link rel="alternate" type="application/rss+xml" title="jQuery Plugin Registry &raquo; Feed" href="http://plugins.jquery.com/feed/" />
<link rel="alternate" type="application/rss+xml" title="jQuery Plugin Registry &raquo; Comments Feed" href="http://plugins.jquery.com/comments/feed/" />
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://plugins.jquery.com/xmlrpc.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="http://plugins.jquery.com/wp-includes/wlwmanifest.xml" /> 
<meta name="generator" content="WordPress 3.5.1" />

</head>
<body class="jquery error404 single-author">
...
<div id="container">
	<div id="logo-events" class="constrain clearfix">
		<h2 class="logo"><a href="/" title="jQuery Plugin Registry">jQuery Plugin Registry</a></h2>

		<aside><a href="http://events.jquery.org/2013/austin/"><img src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/images/ads/jqconaustin.png"></a></aside>
	</div>

	<nav id="main" class="constrain clearfix">
		<div class="menu-top-container">
	<ul id="menu-top" class="menu">
<li class="menu-item"><a href="http://plugins.jquery.com/docs/names/">Naming Your Plugin</a></li>
<li class="menu-item"><a href="http://plugins.jquery.com/docs/publish/">Publishing Your Plugin</a></li>
<li class="menu-item"><a href="http://plugins.jquery.com/docs/package-manifest/">Package Manifest</a></li>
	</ul>
</div>

		<form method="get" class="searchform" action="http://plugins.jquery.com/">
	<button type="submit" class="icon-search"><span class="visuallyhidden">search</span></button>
	<label>
		<span class="visuallyhidden">Search jQuery Plugin Registry</span>
		...
		<div class="row">
			<div class="five columns">
				<ul class="footer-icon-links">
					<li><a class="icon-github" href="http://github.com/jquery/plugins.jquery.com">GitHub <small>Plugins <br>Registry</small></a></li>
					<li><a class="icon-group" href="http://forum.jquery.com">Forum <small>Community <br>Support</small></a></li>
					<li><a class="icon-warning-sign" href="http://github.com/jquery/plugins.jquery.com/issues">Bugs <small>Issue <br>Tracker</small></a></li>
				</ul>
			</div>
				...
				<ul class="presentations">
					<li>
						<a href="http://addyosmani.com/blog/building-spas-jquerys-best-friends/">
							<span><img src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/content/presentations/building-spas-jquerys-best-friends.jpg" alt="Building Single Page Applications With jQuery's Best Friends by Addy Osmani" width="142" height="92" /></span>
					...
					<li>
						<a href="http://addyosmani.com/jqprovenperformance/">
							<span><img src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/content/presentations/addyosmani-2.jpg" alt="jQuery Performance Tips &amp; Tricks by Addy Osmani" width="142" height="92" /></span>
				...
				<ul class="books">
					<li>
						<a href="http://link.packtpub.com/S3Fr9Q">
							<span class="bottom"><img src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/content/books/learning-jquery-3rd-ed.jpg" alt="Learning jQuery 3rd Edition by Karl Swedberg and Jonathan Chaffer" width="92" height="114" /></span>
					...
					<li>
						<a href="http://www.manning.com/affiliate/idevaffiliate.php?id=648_176">
							<span><img src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/content/books/jquery-in-action.jpg" alt="jQuery in Action by Bear Bibeault and Yehuda Katz" width="92" height="114" /></span>
					...
					<li>
						<a href="http://www.syncfusion.com/resources/techportal/ebooks/jquery?utm_medium=BizDev-jQuery.org0513">
							<span><img src="http://plugins.jquery.com/jquery-wp-content/themes/jquery/content/books/jquery-succinctly.jpg" alt="jQuery Succinctly by Cody Lindley" width="92" height="114" /></span>
...
<script>
    ...
    _gaq.push(['_setDomainName', 'plugins.jquery.com']);
